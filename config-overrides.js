...
const overrides = [
  ...
  overrideProcessEnv({
    ...
    PROJECT_WEB_URL: JSON.stringify('https://bif-studio.test.ide.black/'),
    PROJECT_DESKTOP_URL: JSON.stringify('https://app.obsidians.io/bif'),
    ...
    CHAIN_NAME: '"BIF-Core"',
    CHAIN_SHORT_NAME: '"BIF"',
    CHAIN_EXECUTABLE_NAME: '"AA"',
    CHAIN_EXECUTABLE_NAME_IN_LABEL: '"AA"',
    COMPILER_NAME: '"BIF-Compiler"',
    COMPILER_NAME_IN_LABEL: '"BIF-Compiler"',
    COMPILER_EXECUTABLE_NAME: '"caictdevelop/bif-solidity"',
    CHAIN_EXECUTABLE_NAME_IN_LABEL: '"caictdevelop/bif-solidity"',
    COMPILER_VERSION_KEY: '"caictdevelop/bif-solidity"',
    DOCKER_IMAGE_NODE: '"ethereum/client-go"',
    DOCKER_IMAGE_COMPILER: '"caictdevelop/bif-solidity"',
